...
public class licPaging {
	...
	@RequestMapping("/menu/license.com")
	   ...
	   @RequestParam(value="page",defaultValue="1") String page) 
	 {
	  ...
	  //페이징 처리
	  List<lDto> list=dao.getAlldatas();
	  int totalcount;
	  int limit;
	  int currentpage;
	  int totalpage;
